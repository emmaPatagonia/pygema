...
# # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # # 
# define station name and date

this_day = UTCDateTime()
...
plot_helicorder(st, include_events_pygemadb=True, include_last_update_title=True, dark_background=True, show_plot=False, savedir="figs")
