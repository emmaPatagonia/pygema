    ...
    try:
      if network=="GM":
        ...
        if len(st)>0:
          ...
          plot_three_component_waveforms(st, gaps, vel_units=True, include_triggers=False, include_last_update_title=True, dark_background=True, show_plot=False, savedir=savedir)
