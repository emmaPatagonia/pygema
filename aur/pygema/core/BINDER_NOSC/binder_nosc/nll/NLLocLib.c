...
DMatrix wt_matrix = NULL;
DMatrix edt_matrix = NULL;
...
INLINE double calc_maximum_likelihood_ot(double *pot_ml_arrival, double *pot_ml_arrival_edt_sum, int num_arrivals, ArrivalDesc *arrival, DMatrix edtmtx, double *pot_ml_var, int iwrite_errors,
double *pprob_max)
{
...
INLINE double calc_likelihood_ot(double *pot_ml_arrival, double *pot_ml_arrival_edt_sum, int num_arrivals, ArrivalDesc *arrival, DMatrix edtmtx, double time) {
...
INLINE double calc_variance_ot(double *pot_ml_arrival, double *pot_ml_arrival_edt_sum, int num_arrivals, ArrivalDesc *arrival, DMatrix edtmtx, double expectation_time) {
